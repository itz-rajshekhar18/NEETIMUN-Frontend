...
import { StaggerContainer, FadeUp, FadeIn } from "@/components/ui/motion";
...
export function Footer() {
  return (
    <footer className="bg-navy-950 text-cream-200">
      <Container>
        <StaggerContainer
          className="grid grid-cols-1 gap-12 py-16 sm:grid-cols-2 lg:grid-cols-4"
          stagger={0.12}
          delayChildren={0.1}
        >
          <FadeUp viewportTrigger={false} className="flex flex-col gap-4">
          ...
          <FadeUp viewportTrigger={false} className="flex flex-col gap-3">
      ...
      <div className="border-t border-cream-50/10">
        <Container>
          <FadeIn delay={0.3}>
            <div className="flex flex-col items-center justify-between gap-4 py-6 text-xs text-cream-200/60 sm:flex-row">
